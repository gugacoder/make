...
namespace PackDm.Algorithms
{
  ...
  {
    private static Dictionary<string, Model.Index> indexes;
    private static readonly object synclock = new object();

    static RepositoryIndexResolver()
    {
      indexes = new Dictionary<string, Model.Index>();
    }

    public Model.Index ResolveIndex(Uri uri)
    {
      lock (synclock)
      {
    ...
    private Model.Index DownloadRepositoryIndex(Uri uri)
    {
