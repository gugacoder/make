...
namespace Do
{
  ...
  {
    /// <summary>
    /// Adiciona um único elemento ao fim de um enumerado.
    /// </summary>
    ...
    /// <returns>O enumerado com o objeto acrescentado.</returns>
    public static IEnumerable<T> Append<T>(this IEnumerable<T> enumerable, T single)
    {
